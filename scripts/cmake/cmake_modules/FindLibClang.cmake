...
if (NOT LLVM_CONFIG)
  ...
  if (NOT LLVM_CONFIG)
    ...
    set(llvm_config_names "llvm-config-6.0")
...
if (NOT EXISTS ${CLANG_INCLUDEDIR})
  set(CLANG_INCLUDEDIR $ENV{LIBCLANG_INCLUDE_DIR})
  if (NOT EXISTS ${CLANG_INCLUDEDIR})
...
if (NOT EXISTS ${CLANG_LIBDIR})
  set(CLANG_LIBDIR $ENV{LIBCLANG_LIBRARY_DIR})
  if (NOT EXISTS ${CLANG_LIBDIR})
...
if (NOT CLANG_LIBS)
  set(CLANG_LIBS $ENV{LIBCLANG_LIBRARY})
  if (NOT CLANG_LIBS)
