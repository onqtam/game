...
if args.g == 'js':
    ...
    command.append('-DEMSCRIPTEN_ROOT=' + os.getcwd() + '/../../emscripten/emscripten/1.35.0')
    command.append('-DCMAKE_TOOLCHAIN_FILE=' + os.getcwd() + '/../../emscripten/emscripten/1.35.0\cmake\Modules\Platform\Emscripten.cmake')
