...
os.system("git submodule deinit third_party/bgfx/bgfx")
os.system("git submodule deinit third_party/bgfx/bx")
os.system("git submodule deinit third_party/bgfx/bimg")
